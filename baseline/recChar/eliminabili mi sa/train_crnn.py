...
train_dataset = OCRDataset('F:/progetto computer vision/dataxricChar/train/labels.txt', 'F:/progetto computer vision/dataxricChar/train/images', transform)
val_dataset = OCRDataset('F:/progetto computer vision/dataxricChar/val/labels.txt', 'F:/progetto computer vision/dataxricChar/val/images', transform)
